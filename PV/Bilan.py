...
def Bilan2(conso_perso, profil, territ, surface, installation, puissance, NbrekWhfacture, Recurrencefacture,
           Montantfacture, Nbreetages, type, NbreVS, NbkmanVS, NbreVU, NbkmanVU, Presenceparking, Nb_pdc_choisi, Accessibilite_parking, Optionborne):
    ...
    Economies_PV = Economies_pv(conso_perso, profil, territ, surface, installation, puissance,
                                NbrekWhfacture, Recurrencefacture, Montantfacture, Nbreetages, type)
    Economies_Mobilite = Economies_mobilite(
        territ, NbreVS, NbkmanVS, NbreVU, NbkmanVU, Presenceparking, Nb_pdc_choisi, Accessibilite_parking, Optionborne)

    # Projection des coûts Après Actions : Economique
    Bilan_apres[0, 0] = Bilan_avant[0, 0] - \
        Economies_MDE[0, 0]-Economies_PV[0, 0]
    Bilan_apres[0, 1] = Bilan_avant[0, 1]-Economies_Mobilite[0, 0]
    Bilan_apres[0, 2] = Bilan_apres[0, 0] + Bilan_apres[0, 1]

    Bilan_apres[0, 3] = Bilan_avant[0, 3] - \
        Economies_MDE[0, 1]-Economies_PV[0, 1]
    Bilan_apres[0, 4] = Bilan_avant[0, 4]-Economies_Mobilite[0, 1]
    Bilan_apres[0, 5] = Bilan_apres[0, 3] + Bilan_apres[0, 4]

    Bilan_apres[0, 6] = Bilan_avant[0, 6] - \
        Economies_MDE[0, 2] - Economies_PV[0, 2]
